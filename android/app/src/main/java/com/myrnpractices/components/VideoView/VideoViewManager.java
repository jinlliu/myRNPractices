package com.myrnpractices.components.VideoView;
...
/**
 * Created by jinlliu on 11/30/2016.
 */
...
public class VideoViewManager extends SimpleViewManager<VideoView>{
    ...
    public void setSource(RCTVideoView videoView,@javax.annotation.Nullable ReadableMap source){
        if(source != null){
